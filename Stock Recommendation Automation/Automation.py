...
EMAIL_ADDRESS = creds.mymail
EMAIL_PASSWORD = creds.mypw
...
def SendMail():
    with smtplib.SMTP('smtp.gmail.com', 587) as smtp:
        ...
        RTSI
        {rtsiinstance.recommender()}

        Good luck!"""
    
        return smtp.sendmail(EMAIL_ADDRESS, '<Receiver email address here>', msg)
